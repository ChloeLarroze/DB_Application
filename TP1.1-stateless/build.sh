...
# # =========================
# #jar cvf $SERVER_DIR/$EJB_JAR META-INF cl/*.class #jar cvf $SERVER_DIR/$EJB_JAR -C $SERVER_DIR cl -C $SERVER_DIR META-INF
# #jar cvf BonjourEJB.jar META-INF cl/*.c #I know for sure this one worked in my terminal
# #jar cvf $SERVER_DIR/$EJB_JAR -C $SERVER_DIR META_INF -C $SERVER_DIR cl/*.class
...
# asadmin deploy --force $SERVER_DIR/$EJB_JAR
